...
![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/4dc6e4a6685c45d78552142afc95f044~tplv-k3u1fbpfcp-watermark.image?)
...
这里分享一个office安装包，天翼云盘下载，不限速但是需要下载客户端，https://cloud.189.cn/t/zIzMJvmemEBf（访问码：ap4b）

不得不说，云盘厂商基本都是一个套路，刚开始免费不限速，用户量上来了就开始会员制了。阿里云盘已经开始收费了。。。

## markdown 笔记——typora

Typora 是一款简洁的markdown编辑器、写作软件。它去除了预览窗口，模式切换器，语法符号以及所有其他不必要的干扰。将它们替换为真实的实时预览功能，以帮助您专注于内容本身。https://cloud.189.cn/t/yYB36zr2aiAj（访问码：icf3）
...
这里分享一个下载链接：https://cloud.189.cn/t/677Jvm36ziQj（访问码：xvs1）
...
这是一款 Github 开源应用。下载地址：https://github.com/iina/iina/releases

## 视频下载

Downie for Mac 是一款Mac OS平台上最好用的Mac视频下载工具，Downie for mac 支持1000多个不同的视频网站视频下载，功能强大使用简单。

下载链接：https://cloud.189.cn/t/ru6neifEBZVr（访问码：2gu8）

## 图像处理

Adobe Photoshop 2022 是一款专业强大的图片处理工具，设计师必备工具，这个无需多做介绍了吧。https://cloud.189.cn/t/iAZjqyB7ZVvm（访问码：uef9）

Pixelmator Pro 是一款任何人都可以使用的专业图像编辑工具。Pixelmator Pro旨在使每个人都可以使用最强大的专业图像编辑工具。拥有大量用于编辑和修饰照片，创建图形设计，绘画，绘制矢量图形以及添加令人惊叹的效果的工具，这是一款可以替代Photoshop的图像编辑器。https://cloud.189.cn/t/FRZ7raJFVFFn（访问码：hv7d）

## 视频工具——VideoProc

VideoProc Converter 4K 是 Mac 平台上的一款集视频编辑、视频格式转换、在线视频下载、DVD转换、屏幕录像于一体的mac全能视频编辑工具。可以转换格种视频及音频格式，编辑4K、5K、8K视频。轻松剪辑、合并、裁切、分割、添加视频水印、导出字幕等操作。可以加载DVD及ISO镜像，支持下载多个在线视频下载，可以录制屏幕、录制摄像头、录iPhone界面等，功能非常强悍！https://cloud.189.cn/t/EZfqU3Ija2Iz（访问码：1nvq）
...
官网：https://developer.apple.com/cn/xcode/
...
官方网站地址：[https://git-scm.com](https://git-scm.com/ "https://git-scm.com")

点击Downloads --> 选择macOS --> 点击Binary installer的installer或者是2.33.0这两个链接中的一个：

![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/c292916193da42dd8ee0471a66e8863b~tplv-k3u1fbpfcp-watermark.image?)

  

引导安装：

![image.png](https://p6-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/12c359af850847a795900afc2a91c6f0~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p9-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/fd2df0d8463f484cbc9ec121d0e2b641~tplv-k3u1fbpfcp-watermark.image?)
...
官网下载地址：[https://cmake.org/download/](https://cmake.org/download/)
...
![image.png](https://p1-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/e5637c8ec59646ef929f75374f48b3e3~tplv-k3u1fbpfcp-watermark.image?)
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/41997131840c4be8babeff04e91f6431~tplv-k3u1fbpfcp-watermark.image?)
...
查看官方教程，项目地址：[https://github.com/ohmyzsh/ohmyzsh](https://github.com/ohmyzsh/ohmyzsh)
...
可以在这查看主题样式：https://github.com/ohmyzsh/ohmyzsh/wiki/themes
...
![image.png](https://p3-juejin.byteimg.com/tos-cn-i-k3u1fbpfcp/dc53eb7df42e4379b96deb8edfef3821~tplv-k3u1fbpfcp-watermark.image?)
...
gitpod.io 是一个的在线的编程环境。 只需要浏览器打开https://gitpod.io/  用 github 账号登录，就可以编码运行而无需其他配置。

## Java

oracle jdk下载：https://www.oracle.com/java/technologies/downloads/#java11-mac

openjdk下载：https://jdk.java.net/
...
中文网下载:https://studygolang.com/dl
...
不过用python大家一般都是直接安装[Anaconda](https://www.anaconda.com/products/distribution)更好管理环境
...
### 设置终端代理
```
export https_proxy=http://192.168.5.150:20171 http_proxy=http://192.168.5.150:20171 all_proxy=socks5://192.168.5.150:20170
```
