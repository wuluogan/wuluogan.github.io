...
Flag.Event = function(ID,Map,Event,HeroLocation,Floor,callback){
  ...
  switch(ID){
    case 0:
      ...
      Message = ["[Npc=3,仙子]我看你有些战斗能力，这把红钥匙就给你了。祝你能打败魔王，逃出这里"];
      Event.ShowMessageList(Message,function(){
        Flag.Move = false;
        Event.UnlockMove();
        Event.Enable("Controller");
    ...
    case 3:
      Event.Disable("Controller");
      Message = ["[Npc=0,老人]这本怪物图鉴是我年轻时所收集的怪物数据，就送给你吧"];
      Event.ShowMessageList(Message,function(){
        Flag.Move = false;
        Event.UnlockMove();
        Event.Enable("Controller");
    ...
    case 7:
      ...
      Message = ["[Enemy=14,骷髅队长]很好，你竟然有能力闯到这里，不过我又怎么会让你从我这通过呢？"];
      ...
      Event.ShowMessageList(Message,function(){
        ...
        Message = ["[Enemy=14,骷髅队长]除非解决掉这些初级法师，你才有资格挑战！"];
        window.setTimeout(function(){
          Event.ShowMessageList(Message,function(){
            Map.DoorOpen(4,8);
            Event.UnlockMove();
    ...
    case 8:
      ...
      if(!Exist){
        Message = ["[Enemy=14,骷髅队长]如果你能解决掉这群大蝙蝠的话，你才能向我们挑战！"];
        Event.ShowMessageList(Message,function(){
          Map.DoorOpen(6,8);
        });
      }
    ...
    case 9:
      ...
      if(!Exist){
        Message = ["[Enemy=14,骷髅队长]不！你将无法战胜骷髅人！"];
        Event.ShowMessageList(Message,function(){
          Map.DoorOpen(8,6);
          Map.DoorOpen(8,4);
        });
    ...
    case 10:
      ...
      if(!Exist){
        Message = ["[Enemy=14,骷髅队长]碰上骷髅武士你必死无疑，来这的勇者无一不死于他们的剑下！"];
        Event.ShowMessageList(Message,function(){
          Map.DoorOpen(6,2);
          Map.DoorOpen(4,2);
        });
    ...
    case 11:
      ...
      if(!Exist){
        Message = ["[Enemy=14,骷髅队长]哼！除非我死了！来吧！我会将你碎尸万段！给我族人复仇！！！"];
        Event.ShowMessageList(Message,function(){
          Map.DoorOpen(2,4);
          Map.DoorOpen(2,6);
          Map.DoorOpen(5,6);
    ...
    case 13:
      Event.Disable("Controller");
      if(!Flag.Switch[1]){
        Message = ["[Npc=1,奸商]嘿嘿嘿，凑够250就来吧！我在这等你！"];
        Event.ShowMessageList(Message,function(){
          Flag.Switch[1] =  true;
          Flag.Move = false;
          Event.UnlockMove();
    ...
    case 14:
      Event.Disable("Controller");
      Message = ["[Npc=0,老人]我听一个小偷说这座塔的1层不是最低层，你可以拿到右下角的下楼器下去，去零层前你还需要有地震卷轴，你是来救公主的，这两个飞羽给你吧，希望能够帮到你，注意中心对称"];
      Event.ShowMessageList(Message,function(){
        Flag.Move = false;
    ...
    case 18:
      Event.Disable("Controller");
      Message = ["[Npc=0,老人]在这之前你还需要有能力打败骑士队长！务必记得存档！"];
      Event.ShowMessageList(Message,function(){
        Flag.Move = false;
    ...
    case 19:
      if(!Flag.Switch[2]){
        ...
        Message = ["[Enemy=28,骑士队长]你可以打败骷髅族但你不可能打败高贵的骑士族！我渴望和你战斗哈哈哈"];
        Event.ShowMessageList(Message,function(){
          Flag.Move = false;
          Event.UnlockMove();
          Event.Enable("Controller");
    ...
    case 20:
      Event.Disable("Controller");
      Flag.EventRuning = true;
      Message = ["[Enemy=36,ZENO]给我把他押下去！对了，重置一下，换个地方，让他继续尝试"];
    ...
    case 25:
      Event.Disable("Controller");
      Message = ["[Npc=1,商人]勇士，谢谢你把我救了出来，为了表达谢意，这十个随意门就给你了！"];
      Event.ShowMessageList(Message,function(){
        Flag.Move = false;
    ...
    case 26:
      Event.Disable("Controller");
      Message = ["[Npc=2,小偷]嘿！勇士，瞧见第六层的老头没，他是我朋友，谢谢你救了我，我这有三把铁门钥匙，给你吧！"];
      Event.ShowMessageList(Message,function(){
        Flag.Move = false;
    ...
    case 31:
      Event.Disable("Controller");
      Flag.EventRuning = true;
      Message = ["[Enemy=36,ZENO]你！你怎么发现这的！？？哈哈哈，还真是我失策了，一开始就应该夺去你的能力！魔法警卫！"];
      if(!Flag.Switch[3]){
      	...
      	window.setTimeout(function(){
  			Event.ShowMessageList(Message,function(){
  			  Map.DrawBattleAnimate(0,HeroLocation[1],HeroLocation[2],function(){
      				...
      				Message = ["[Enemy=36,ZENO]勇士！来吧！来挑战我啊，为了公平起见我的能力也已经大幅削减"];
  			    	Event.ShowMessageList(Message,function(){
  		    			Flag.EventRuning = false;
    ...
    case 32:
      ...
      Event.ShowMessageList(Message,function(){
        ...
        Message = ["[Enemy=36,ZENO]哈哈哈，我说过我是不死的"];
        window.setTimeout(function(){      
      	   Event.ShowMessageList(Message,function(){
      	     Flag.EventRuning = false;
            Flag.Move = false;
