                ...
                for (var i = t(".gallery"), o = 0; o < i.length; o++) {
                    ...
                    f.each(function() {
                        t(this).css({
                            ...
                            "margin-left": w,
                            "margin-right": w
                        }), t(this).hasClass("h2") && a > 800 && t(this).css("height", u + h), t(this).hasClass("w2") && a > 800 && 1 != n && t(this).css("width", 2 * c + h), t(this).hasClass("full") && (t(this).css("width", d - h), "auto" != e && t(this).css("height", s))
                    })
                    for (var v = f.length, m = Math.floor(v / n), p = v - m * n ? v - m * n : n, o = 0; v - p > o; o++) t(f[o]).css("margin-bottom", h)
                    ...
                    r.isotope({
                        ...
                        t(".filters li").removeClass("active"), t(this).addClass("active"), r.isotope({
                            filter: i
                        })
                    })
                }
...
! function(n) {
    ...
    function e(i) {
        i === !0 ? n("#site-nav, #main-overlay").addClass("nav-open") : (n("#site-nav, #main-overlay").removeClass("nav-open"), setTimeout(function() {
    ...
    }), n("#menu li:has(ul)").children("ul").hide(), n("#menu li:has(ul)").find("a").on("click", function() {
        var i = n(this).parent(),
            e = n(this).next("ul")
        return e.is(":visible") && n(this).parent().find("ul").slideUp(300), e.is(":hidden") && (i.siblings().find("ul").slideUp(300), i.find("ul:first").slideDown(300)), 0 == i.find("ul").children().length ? !0 : !1
...
var comm_list = [{
            ...
            list: [{
                    ...
                    link: [{
                        ...
                        {
                            name: "WCMS",
                            url: "https://cms.wulgs.com/"
                        },
                        {
                            name: "WBLOG",
                            url: "https://blog.wulgs.com/"
                        },
                        {
                            name: "搜狗",
    ...
    ! function(o) {
        ...
        function a(t) {
            if (
                ...
                o(t).hasClass("baidu")
            ) o(".search-form").attr("action", "https://www.baidu.com/s"), o(".search-keyword").attr({
                name: "word",
                placeholder: "百度一下，你就知道"
            })
            else if (
                o(t).hasClass("google")
            ) o(".search-form").attr("action", "https://www.google.com/search"), o(".search-keyword").attr({
                name: "q",
                placeholder: "Google 搜索"
            })
            else if (
                o(t).hasClass("bing")
            ) o(".search-form").attr("action", "https://cn.bing.com/search"), o(".search-keyword").attr({
                name: "q",
                ...
                o(t).hasClass("dogedoge")
            ) o(".search-form").attr("action", "https://dogedoge.com/results"), o(".search-keyword").attr({
                name: "q",
                placeholder: "DogeDoge 搜索"
            })
            else if (
                o(t).hasClass("torrent")
            ) o(".search-form").attr("action", "https://torrentz2.eu/search"), o(".search-keyword").attr({
                name: "f",
                placeholder: "磁力链，种子搜索"
            })
            else if (
                o(t).hasClass("scholar")
            ) {
